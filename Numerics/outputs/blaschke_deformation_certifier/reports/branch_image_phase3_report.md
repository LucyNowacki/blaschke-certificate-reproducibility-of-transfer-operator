...
- certified q_star upper = 0.92700000000000005
- certified epsilon_X upper = 0.000000000000000000033264433839017426342178575983234893950031511766904056153480096
- diagnostic epsilon_X divided by q_star^N = 1.87992121720786532100821557548
...
The response-prefactor branch-image row is far smaller than the old whole-ellipse row.  At N=600, M=610 the deterministic radius is controlled by the analytic single-space tails, while the transported collocation matrix defect is negligible.
